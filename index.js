            ...
            if(response.RespCode == 200) {
                ...
                for (let i = 0; i < product.length; i++) {
                    html += `<div onclick="openProductDetail(${i})" class="product-item ${product[i].type}">
                                <img class="product-item img"  src="./images/${product[i].img}" alt="">
...
function searchsomething(elem){
    ...
    for (let i = 0; i< product.length; i++){
        if(product[i].name.includes(value) || product[i].type.includes(value) ){
            html += `<div onclick="openProductDetail(${i})" class="product-item ${product[i].type}">
        <img   src="./images/${product[i].img}" alt="">
        <p class="">
            ${product[i].name}
        </p>
...
//                     Swal.fire({
//                         icon: 'success',
//                         title: 'Your purchase is successful. Thank you'
